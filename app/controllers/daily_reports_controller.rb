class DailyReportsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to daily_reports_path, status: :see_other, notice: "Daily report was successfully destroyed." }
  ...
  private
    ...
    def daily_report_params
      params.require(:daily_report).permit(:construction_responsible_id, :supervisor_id, :service_order_id, :climatic_condition_morning, :climatic_condition_afternoon, :teams_departure_time, :teams_arrival_time, :teams_exit_time, :teams_return_time)
    end
end
